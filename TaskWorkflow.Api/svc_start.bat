...
set SERVICE_NAME=TaskWorkflow API
set EXE_PATH=%~dp0bin\Release\net10.0\win-x64\publish\TaskWorkflow.Api.exe
...
:: Set description
sc description "%SERVICE_NAME%" "TaskWorkflow API - handles task execution requests"
